...
[[ $(type -t GplPostfixAutoinstaller_printHelp) == function ]] || GplPostfixAutoinstaller_printHelp() {
    cat << EOF
GPL Postfix Auto-Installer
Variation Default
Version `GplPostfixAutoinstaller_printVersion`
...
# Title.
title GPL Postfix Auto-Installer
_ 'Variation '; yellow Default; _.
_ 'Version '; yellow `GplPostfixAutoinstaller_printVersion`; _.
____
