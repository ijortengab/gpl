...
Version `GplPhpSetupAdjustCliVersion_printVersion`
...
# Help and Version.
[ -n "$help" ] && { GplPhpSetupAdjustCliVersion_printHelp; exit 1; }
[ -n "$version" ] && { GplPhpSetupAdjustCliVersion_printVersion; exit 1; }
...
_ 'Version '; yellow `GplPhpSetupAdjustCliVersion_printVersion`; _.
