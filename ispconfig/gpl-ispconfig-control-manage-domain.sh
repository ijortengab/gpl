...
Version `GplIspconfigControlManageDomain_printVersion`

EOF
    cat << 'EOF'
Usage: gpl-ispconfig-control-manage-domain.sh [command] [options]
...
_ 'Version '; yellow `GplIspconfigControlManageDomain_printVersion`; _.
____
