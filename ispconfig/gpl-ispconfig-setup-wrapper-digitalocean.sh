...
Version `GplIspconfigSetupWrapperDigitalocean_printVersion`
...
_ 'Version '; yellow `GplIspconfigSetupWrapperDigitalocean_printVersion`; _.
____
...
if [ -z "$ispconfig_domain_exists_sure" ];then
    ...
    INDENT+="    ";
    source $(command -v gpl-ispconfig-control-manage-domain.sh)
    INDENT=${INDENT::-4}
    _;_, ____________________________________________________________________;_.;_.;
...
if [ -z "$digitalocean_domain_exists_sure" ];then
    ...
    INDENT+="    ";
    source $(command -v gpl-digitalocean-api-manage-domain.sh)
    INDENT=${INDENT::-4}
    _;_, ____________________________________________________________________;_.;_.;
...
if [[ $type == spf ]];then
    ...
    INDENT+="    ";
    source $(command -v gpl-digitalocean-api-manage-domain-record.sh) add --type txt --hostname=@ --value="$data" --value-summarize="SPF"
    INDENT=${INDENT::-4}
    _;_, ____________________________________________________________________;_.;_.;
fi
if [[ $type == dmarc ]];then
    ...
    INDENT+="    ";
    source $(command -v gpl-digitalocean-api-manage-domain-record.sh) add --type txt --hostname=_dmarc --value="$data" --value-summarize="DMARC"
    INDENT=${INDENT::-4}
    _;_, ____________________________________________________________________;_.;_.;
fi
if [[ $type == dkim ]];then
    ...
    INDENT+="    ";
    source $(command -v gpl-digitalocean-api-manage-domain-record.sh) add --type txt --hostname=$DKIM_SELECTOR._domainkey --value="$data" --value-summarize="DKIM"
    INDENT=${INDENT::-4}
    _;_, ____________________________________________________________________;_.;_.;
fi
