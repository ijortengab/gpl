...
[[ $(type -t GplNginxAutoinstaller_printHelp) == function ]] || GplNginxAutoinstaller_printHelp() {
    cat << EOF
GPL Nginx Auto-Installer
Variation Default
Version `GplNginxAutoinstaller_printVersion`

EOF
    cat << 'EOF'
Usage: gpl-nginx-autoinstaller.sh [options]
...
# Title.
title GPL Nginx Auto-Installer
_ 'Variation '; yellow Default; _.
_ 'Version '; yellow `GplNginxAutoinstaller_printVersion`; _.
____
