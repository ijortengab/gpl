...
Version `GplDrupalSetupDrushAlias_printVersion`
...
# Help and Version.
[ -n "$help" ] && { GplDrupalSetupDrushAlias_printHelp; exit 1; }
[ -n "$version" ] && { GplDrupalSetupDrushAlias_printVersion; exit 1; }
...
_ 'Version '; yellow `GplDrupalSetupDrushAlias_printVersion`; _.
____
