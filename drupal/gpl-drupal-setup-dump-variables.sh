...
Version `GplDrupalSetupDumpVariables_printVersion`

EOF
    cat << 'EOF'
Usage: gpl-drupal-setup-dump-variables.sh [options]
...
_ 'Version '; yellow `GplDrupalSetupDumpVariables_printVersion`; _.
____
