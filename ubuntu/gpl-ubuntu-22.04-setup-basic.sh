...
# Functions.
[[ $(type -t GplUbuntu2204SetupBasic_printVersion) == function ]] || GplUbuntu2204SetupBasic_printVersion() {
    echo '0.1.0'
}
[[ $(type -t GplUbuntu2204SetupBasic_printHelp) == function ]] || GplUbuntu2204SetupBasic_printHelp() {
    cat << EOF
GPL Ubuntu 22.04 Setup Server
Variation Basic
Version `GplUbuntu2204SetupBasic_printVersion`

EOF
    cat << 'EOF'
Usage: gpl-ubuntu-22.04-setup-basic.sh [options]
...
# Help and Version.
[ -n "$help" ] && { GplUbuntu2204SetupBasic_printHelp; exit 1; }
[ -n "$version" ] && { GplUbuntu2204SetupBasic_printVersion; exit 1; }
...
# Title.
title GPL Ubuntu 22.04 Setup Server
_ 'Variation '; yellow Basic; _.
_ 'Version '; yellow `GplUbuntu2204SetupBasic_printVersion`; _.
____
