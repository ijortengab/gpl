...
GPL Amavis Setup
Variation ISPConfig
Version `GplAmavisSetupIspconfig_printVersion`
...
# Functions.
[[ $(type -t GplAmavisSetupIspconfig_startTweak) == function ]] || GplAmavisSetupIspconfig_startTweak() {
...
# Title.
title GPL Amavis Setup
_ 'Variation '; yellow ISPConfig; _.
_ 'Version '; yellow `GplAmavisSetupIspconfig_printVersion`; _.
____
...
if [ -n "$stdout" ];then
    ...
    GplAmavisSetupIspconfig_startTweak
fi
____
