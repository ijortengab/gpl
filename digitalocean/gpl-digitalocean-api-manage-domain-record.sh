...
Version `GplDigitaloceanApiManageDomainRecord_printVersion`

EOF
    cat << 'EOF'
Usage: gpl-digitalocean-api-manage-domain-record.sh [command] [options]
...
_ 'Version '; yellow `GplDigitaloceanApiManageDomainRecord_printVersion`; _.
____
