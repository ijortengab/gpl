...
# Functions.
[[ $(type -t GplComposerAutoinstaller_printVersion) == function ]] || GplComposerAutoinstaller_printVersion() {
    echo '0.1.0'
}
[[ $(type -t GplComposerAutoinstaller_printHelp) == function ]] || GplComposerAutoinstaller_printHelp() {
    cat << EOF
GPL Composer Auto-Installer
Variation Default
Version `GplComposerAutoinstaller_printVersion`

EOF
    cat << 'EOF'
Usage: gpl-composer-autoinstaller.sh [options]
...
# Help and Version.
[ -n "$help" ] && { GplComposerAutoinstaller_printHelp; exit 1; }
[ -n "$version" ] && { GplComposerAutoinstaller_printVersion; exit 1; }
...
# Title.
title GPL Composer Auto-Installer
_ 'Variation '; yellow Default; _.
_ 'Version '; yellow `GplComposerAutoinstaller_printVersion`; _.
____
